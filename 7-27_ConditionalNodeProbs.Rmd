---
title: "7-19ConditionalProbNodes"
author: "Stephanie Stacy"
date: "July 19, 2016"
output: html_document
---
Coalescent Simulator, phylo object conversion, node theoretical probability calculations
...
```{r create.phylo}
#Given the number of sampled tips and a population size, create.phylo() uses cosim() and traverse() to return a corresponding phylo object.
#want n << N
...
```{r interval.sort}
#takes in a tree and finds the length of each interval
#returns a matrix with the first column the length of the current interval, column 2 as the origin internal node of that interval and column 3 the number of active lineages for that interval
