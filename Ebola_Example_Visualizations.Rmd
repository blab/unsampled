...
Formatting the full ebola tree data and calculating node probabilities and visualizing it:
```{r}
#Ebola Data
...
plot(ebola2, show.tip.label=FALSE, edge.color=pr.tree, edge.width=5)
#plot(ebola2, show.tip.label=FALSE, edge.color=pr.tree, edge.width=20, show.node.label=TRUE, cex=5)
```
...
nodelabels(text = round(node.pr, 4), frame="none", col="#284e57", cex=8)
tiplabels(text=t$tip.label, frame="circle", bg="#8bb9b9", col="white", cex= 8)
#edgelabels(text=t$edge.length, frame="none", adj=c(1,-.1), cex= 8)
